 ...
 *
 * To create a new connection to a resource <R> with initial status <status>, 
 * use rp_open(R, status).
 *
 * To modify the status of the connection to <R> to be <status>, use 
 * rp_open(R, status).
 *
 * To check the status of the connection to <R>, use rp_stat(R).
 *
 * To close a connection to <R>, use rp_close(R).
 *
