 ...
 * io_recv
 *
 * Extract an I/O command from the given message <msg>. If the message
 * contained is not a valid I/O command, this function returns NULL.
 */
